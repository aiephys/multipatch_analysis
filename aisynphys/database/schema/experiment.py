...
Pair = make_table(
    ...
    columns=[
        ...
        ('has_synapse', 'bool', 'Whether a chemical mono-synapse was manually detected for this cell pair', {'index': True}),
        ('has_polysynapse', 'bool', 'Whether a chemical poly-synapse was manually detected for this cell pair', {'index': True}),
