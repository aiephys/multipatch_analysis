...
Dynamics = make_table(
    ...
    columns=[
        ...
        ('pulse_amp_stp_induction_50hz', 'float', 'Median amplitude of 5th-8th pulses on 50 hz trains', {}),
        ('pulse_amp_stp_recovery_50hz', 'float', 'Median amplitude of 9th-12th pulses on 50 hz trains', {}),
        ('pulse_amp_stp_recovery_single_50hz', 'float', 'Median amplitude of 9th pulse on 50 hz trains', {}),
