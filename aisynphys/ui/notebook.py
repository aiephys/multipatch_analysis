...
def show_connectivity_matrix(ax, results, pre_cell_classes, post_cell_classes, class_labels, cmap, norm, ctype='chemical', distance_adjusted=False, cbarlabel='Adjusted connection probability', alpha=True):
