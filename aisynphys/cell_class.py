...
def classify_cells(cell_classes, cells=None, pairs=None, missing_attr=None):
    ...
    missing_attr: 'ignore' | None
        Ignore the cell typing exception if an attribute can't be found and move on
