...
from .. import config, synphys_cache, experiment_list, constants
from .. import lims
...
class ExperimentPipelineModule(PipelineModule):
    ...
    def process_job(cls, job_id):
        ...
        # if expt.nwb_file is not None:
        #     _load_nwb(session, expt_entry, elecs_by_ad_channel, pairs_by_device_id)
