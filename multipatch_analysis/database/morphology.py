...
Morphology = make_table(name='morphology', comment="Describes morphological properties of cells.", columns=[
    ...
    ('cell_specimen_id', 'int', 'LIMS cell specimen ID', {'index': True}),
    ('morpho_db_hash', 'str', 'hash of Morphology team database for update tracking', {'index': True}),
    ('pyramidal', 'str', 'whether the experimenter labeled the cell as pyramidal', {'index': True}),
    ...
    ('apical_trunc_distance', 'str', 'measured distance to truncation of apical dendrite', {'index': True}),
    ('axon_trunc_distance', 'str', 'measured distance to truncation of axon', {'index': True}),
