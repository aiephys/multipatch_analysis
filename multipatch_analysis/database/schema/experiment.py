...
Pair = make_table(
    ...
    columns=[
        ...
        ('synapse', 'bool', 'Whether a chemical synapse was manually detected for this cell pair', {'index': True}),
        ('synapse_type', 'str', '"ex" or "in" indicating whether the synapse is excitatory or inhibitory', {'index': True}),
        ('electrical', 'bool', 'Whether an electrical synapse / gap junction was manually detected for this cell pair', {'index': True}),
