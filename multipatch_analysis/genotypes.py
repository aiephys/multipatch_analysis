...
class Genotype(object):
    ...
    def expressed_reporters(self, drivers):
        ...
        ----------
        drivers : list
            The list of active drivers
        """
        return self._driver_reporter_map[tuple(sorted(drivers))]

    def expressed_colors(self, drivers):
        """Return a list of fluorescent emission colors generated by reporters in this genotype
        that would be expressed given a list of active drivers (such as pvalb, tlx3, etc.)
    ...
    def predict_driver_expression(self, colors):
        ...
        return predictions about whether each combination of drivers could have been active.
        ...
        driver_expression : dict
            Dict indicating whether each driver combination in the genotype could be expressed
        ...
        for drivers in self._driver_combinations():
            drivers_active = None  # start with no information
            ...
            for color in self.all_colors:
                ...
                if color_expressed is None or color_predicted is None:
                    continue
                if color_expressed is True and color_predicted is True:
                    drivers_active = True
                if color_predicted != color_expressed:
                    drivers_active = False
                    break
            predictions[drivers] = drivers_active
        return predictions
