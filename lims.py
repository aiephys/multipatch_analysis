...
def submit_expt(nwb_file):
    ...
    lims_session = limstk.limstk.Session(
    ...
    lims_session.schedule_manifest(trigger_file='Chat-IRES-Cre-neo;Ai14-316041.04.01_ephys_cell_cluster_1234.mp')
